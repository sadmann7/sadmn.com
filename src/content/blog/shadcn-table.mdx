...
A shadcn table component with server-side sorting, filtering, and pagination, bootstrapped with `create-t3-app`.

[![Shadcn Table](./public/images/blog/shadcn-table.png)](https://table.sadmn.com)
