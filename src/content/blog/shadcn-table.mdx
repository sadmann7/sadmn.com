...
Would like to thank the creators of `shadcn/ui` and `TanStack/react-table` for their excellent work. Really thankfull to Kavin Desi Valli for building the dynamic filtering feature. You'all can check his YouTube channel [here](https://www.youtube.com/@livecode247). This project is a testament to the power of open-source collaboration and the endless possibilities it offers for creating innovative solutions. I hope this project inspires developers to explore new ways of integrating technologies and building robust, user-friendly applications.
